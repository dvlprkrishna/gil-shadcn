...
const Subscribe = () => {
  return (
    ...
    <div className="container text-center py-24 px-10 rounded-3xl  bg-[linear-gradient(180deg,_rgba(0,98,255,0.61)_2%,_rgba(83,57,229,0)_100%)]">
      ...
      <div className="my-10 max-w-3xl text-center mx-auto  bg-[rgb(195,21,169)] bg-[linear-gradient(90deg,_rgba(195,21,169,1)_0%,_rgba(137,40,200,1)_50%,_rgba(83,57,229,1)_100%)] p-1 rounded-full">
